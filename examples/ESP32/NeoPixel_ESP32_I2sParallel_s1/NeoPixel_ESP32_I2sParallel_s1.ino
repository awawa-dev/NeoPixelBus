...
NeoPixelBus<NeoGrbwFeature, NeoEsp32I2s1X8Sk6812Method>* strip0;
NeoPixelBus<NeoGrbwFeature, NeoEsp32I2s1X8Sk6812Method>* strip1;
...
void setup() {
    ...
    //Serial.flush();
    delay(2000);
    strip0 = new NeoPixelBus<NeoGrbwFeature, NeoEsp32I2s1X8Sk6812Method>(PixelCount, 4);
    strip1 = new NeoPixelBus<NeoGrbwFeature, NeoEsp32I2s1X8Sk6812Method>(PixelCount, 2);
